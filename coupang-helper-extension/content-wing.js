/* ============================================================
   Coupang Sourcing Helper — WING Content Script v4.5
...
(function () {
  ...
  // ============================================================
  //  3) DOM 기반 인기상품 파싱 (Fallback) — v4.5 대폭 개선
  // ============================================================
  ...
  function parseWingPopularProducts() {
    ...
    // -- 전략 B: WING 인기상품 카드/리스트 기반 파싱 (v4.5 강화)
    const cardSelectors = [
  ...
  // ============================================================
  //  검색 컨텍스트 감지 — v4.5 searchKeywords(복수형) 추가
  // ============================================================
