...
const EXTENSION_ZIP_URL = "/coupang-helper-extension-v7.3.0.zip";
          ...
          <div className="space-y-3">
            ...
            <AccordionSection icon={Chrome} title="1. 설치 방법" defaultOpen={true}>
              <div className="space-y-4 mt-3">
                <Step num={1} title="확장프로그램 파일 다운로드" desc="위의 다운로드 버튼을 클릭하여 coupang-helper-extension-v7.3.0.zip 파일을 받습니다." />
                ...
                {[
                  {
                    ...
                    badge: "Latest",
                    changes: [
                      "★ 핵심 수정: 탭 내 DOMParser 기반 파싱 (리뷰/평점 100% 정상 수집)",
                      "Service Worker에서 DOMParser 미지원 → 탭 내 executeScript로 DOM 파싱 실행",
                      "tab_script / hidden_tab_polling 전략에서 파싱 결과를 직접 반환",
                      "direct_fetch(SSR HTML) 리뷰 0% → tab 기반 수집으로 리뷰율 90%+ 정상화",
                      "수집 전략: tab_script → hidden_tab_polling → direct_fetch → dnr_fetch",
                    ],
                  },
                  {
                    version: "v7.2.9",
                  ...
                  },
                  {
                    ...
                    date: "2026-03-10",
                    changes: [
                      "수집수 N = N개씩 라운드 수집 (전체 키워드를 N개씩 나눠 순차 수집)",
                      "수집 딜레이 최적화: 50~89초 → 25~45초 (수집 속도 2배 향상)",
                      "키워드 로드 제한 100 → 200개로 확대",
                      "라운드 진행률 표시 (R1/5 형식)",
                      "라운드 단위 드롭다운: 2개씩~전체 한번에",
                    ],
                  },
                  {
                    version: "v7.2.6",
