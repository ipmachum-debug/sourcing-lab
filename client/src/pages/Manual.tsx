...
const EXTENSION_ZIP_URL = "/coupang-helper-extension-v8.7.1.zip";
        ...
        <div className="space-y-4">
          ...
          <Section id="install" icon={Download} title="1. 설치 방법" defaultOpen>
            <div className="space-y-4 mt-4">
              ...
              <StepCard num={2} title="압축 해제" desc="다운로드한 coupang-helper-extension-v8.7.1.zip의 압축을 풀어줍니다. (폴더 안에 manifest.json 파일이 있어야 합니다)" color="bg-blue-500" />
