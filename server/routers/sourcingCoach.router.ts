...
const KO_TO_CN: Record<string, string> = {
  ...
  '고데기': '卷发棒', '헤어': '头发', '전문가용': '专业',
  '초고출력': '大功率', '고출력': '大功率',
  '전동칫솔': '电动牙刷', '마사지기': '按摩器', '안마기': '按摩器',
};
...
const KO_TO_EN: Record<string, string> = {
  ...
  // 미용/뷰티 가전
  '드라이어': 'hair dryer', '드라이기': 'hair dryer', '헤어드라이어': 'hair dryer',
  '헤어드라이기': 'hair dryer', '고데기': 'hair curler', '전문가용': 'professional',
  '초고출력': 'high power', '고출력': 'high power',
};
